...
const Portfolio=()=>{
    ...
    return(
      ...
      <div className="portfolio--container-box">
        ...
        <div>
          <button className="btn btn-github" onClick={()=>window.open("https://github.com/AdarshYadav04",'_blank')}>
            <svg
        ...
        {data?.portfolio?.map((item, index) => (
          <div key={index} className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              ...
              <p className="text-sm portfolio--link" onClick={()=>window.open(item.link,"_blank")}>
                  View In Github
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
